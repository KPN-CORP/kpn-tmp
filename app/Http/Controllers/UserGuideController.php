...
use App\Http\Requests\StoreUserGuideRequest;
use App\Http\Requests\UpdateUserGuideRequest;
...
class UserGuideController extends Controller
{
     ...
     */
    public function update(UpdateUserGuideRequest $request, UserGuide $userGuide)
    {
        //
    }
